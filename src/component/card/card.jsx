...
const Card = ({ card, handleCLick }) => {
    const {id,name, age, role, image, salary, country } = card
    return (
        <div className='mx-auto border-2 shadow-gray-500 p-10  text-center space-y-2 '>
            ...
            <button onClick={()=>handleCLick(card,salary,id)} className='px-5 py-3 rounded-lg bg-purple-600 text-white'>Hire</button>
        </div>
    );
};
